"""Demo 2 知识库 Agent 真实 LLM 端到端（agent: package-e2e-real-w82）。

# test_demo2_rag_e2e.py（agent: package-e2e-real-w82）
Wave 8.2 WT-L3：跑 ``demos.demo2_rag`` + 真实 RAG 后端。
"""
...
# Demo 2 真实 LLM 跑通（agent: package-e2e-real-w82）
async def test_demo2_rag_e2e(e2e_report) -> None:
    """跑 ``Demo2Rag`` + 记录 E2ERunResult。"""
