...
from kivi_agent.core.bus.envelope import HandlerError
from kivi_agent.core.events.bus import EventBus
from kivi_agent.core.runner import RunOutcome
from kivi_agent.core.session.manager import SESSION_CLOSED, SESSION_NOT_FOUND, SessionManager
...
# 设计：复用 mock runner 的成功路径，聚焦 mode 对最终状态的影响，保证 kivi run 的统一路径正确
