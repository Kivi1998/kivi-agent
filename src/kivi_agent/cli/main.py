...
from kivi_agent.cli.commands.chat import cmd_chat
from kivi_agent.cli.commands.core import cmd_core_start, cmd_core_status, cmd_core_stop
from kivi_agent.cli.commands.ping import cmd_ping
from kivi_agent.cli.commands.run import cmd_run
from kivi_agent.cli.commands.trace import cmd_trace
from kivi_agent.cli.commands.version import cmd_version
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="kivi", description="kivi-agent CLI")
