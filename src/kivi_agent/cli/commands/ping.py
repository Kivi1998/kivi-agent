...
import kivi_agent
from kivi_agent.core.bus.commands import PongResult
from kivi_agent.core.bus.envelope import JsonRpcError, JsonRpcSuccess
...
async def _ping(config: KamaConfig) -> None:
    ...
    req = {
        ...
        "id": "cli-1",
        "method": "core.ping",
        "params": {"client": f"cli/{kivi_agent.__version__}"},
    }
