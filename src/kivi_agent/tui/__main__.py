...
from kivi_agent.tui.app import run

_DEFAULT_TUI_LOG = "~/.kivi/logs/tui.log"
...
# kivi-tui 入口：解析 --replay 参数后启动 TUI 应用
def main() -> None:
    parser = argparse.ArgumentParser(prog="kivi-tui", description="kivi-agent TUI")
    parser.add_argument(
        "--replay",
        metavar="RUN_ID",
