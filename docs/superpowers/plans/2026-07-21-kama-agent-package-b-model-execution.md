...
**Files:**
- Create: `src/kama_claude/core/llm/catalog.py`
- Modify: `src/kama_claude/core/llm/provider.py`
- Modify: `src/kama_claude/core/llm/openai_compat_provider.py`
...
```python
# src/kama_claude/core/llm/catalog.py
from __future__ import annotations
...
git add src/kama_claude/core/llm/catalog.py src/kama_claude/core/llm/provider.py \
        src/kama_claude/core/llm/openai_compat_provider.py tests/unit/test_llm_catalog.py
...
**Files:**
- Create: `src/kama_claude/core/llm/streaming.py`
- Modify: `src/kama_claude/core/llm/openai_compat_provider.py`
...
```python
# src/kama_claude/core/llm/streaming.py
from __future__ import annotations
...
```bash
git add src/kama_claude/core/llm/streaming.py src/kama_claude/core/llm/openai_compat_provider.py \
        tests/unit/test_streaming_collector.py
...
**Files:**
- Create: `src/kama_claude/core/tools/executor.py`
...
from kama_claude.core.llm.types import ToolCallBlock
from kama_claude.core.tools.executor import partition_tool_calls
...
```python
# src/kama_claude/core/tools/executor.py
from __future__ import annotations
...
from kama_claude.core.events.bus import EventBus
from kama_claude.core.tools.executor import execute_tool_batches
...
```bash
git add src/kama_claude/core/tools/executor.py src/kama_claude/core/loop.py tests/unit/test_tool_executor.py
...
**Files:**
- Modify: `src/kama_claude/core/tools/registry.py`
- Create: `src/kama_claude/core/tools/builtin/tool_search.py`
...
```python
# src/kama_claude/core/tools/registry.py（完整替换）
from __future__ import annotations
...
```python
# src/kama_claude/core/tools/builtin/tool_search.py
from __future__ import annotations
...
```bash
git add src/kama_claude/core/tools/registry.py src/kama_claude/core/tools/builtin/tool_search.py \
